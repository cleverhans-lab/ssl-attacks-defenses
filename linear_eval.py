...
if args.modeltype == "stolen":
    ...
    if args.defence == "True":
        log_dir = f"/checkpoint/{os.getenv('USER')}/SimCLR/{args.epochs}{args.arch}{args.losstype}DEFENCE/"  
        logname = f'testing{args.modeltype}{args.dataset_test}{args.num_queries}.log'
    if args.victimhead == "True":
        log_dir = f"/checkpoint/{os.getenv('USER')}/SimCLR/{args.epochs}{args.arch}{args.losstype}STEALWVICH/"  
        logname = f'testing{args.modeltype}{args.dataset_test}{args.num_queries}.log'
else:
